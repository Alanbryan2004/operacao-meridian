export const Caso7Scenarios = [
  ...
  // Cenário 2 — Maresia
  {
    ...
    interrogatorios: [
      ...
      { id: "S2_12", cidade: "Lisboa", local: "Restaurante", personagem: "Garçom", imgLocal: "/NPC/Restaurante.png", imgPersonagem: "/NPC/Garcon.png", pista: "Ele comentou que era Latino Americano." },
