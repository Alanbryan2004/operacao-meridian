export const Caso10Scenarios = [
  ...
  // Cenário 2 — Eco de Ferro
  {
    ...
    travelTable: {
      ...
      "Roma": ["Paris", "Toronto", "Berlim"],
      "Paris": ["Trípoli", "Cairo", "Mumbai"],
      "Trípoli": ["Madrid", "Viena", "Pequim"],
      "Madrid": ["São Paulo", "Toronto", "Cairo"],
      "São Paulo": ["Rio de Janeiro", "Lisboa", "Vancouver"],
      "Rio de Janeiro": []
    },
    interrogatorios: [
  ...
  // Cenário 4 — Duque
  {
    ...
    travelTable: {
      ...
      "Lisboa": ["Rio de Janeiro", "Toronto", "Buenos Aires"],
      "Rio de Janeiro": ["Buenos Aires", "Seul", "Santiago"],
      "Buenos Aires": ["Madrid", "Lisboa", "Roma"],
      "Madrid": ["Roma", "Paris", "Berlim"],
      "Roma": ["São Paulo", "Vancouver", "Amsterdã"],
