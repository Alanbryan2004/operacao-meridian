...
export const DESTINATION_OPTIONS = [
    ...
    // De Dublin
    { id: "DUB_GB", pais: "Reino Unido", cidade: "Londres", origem: "Dublin", coords: { x: 184, y: 38 }, flag: "🇬🇧" },
    { id: "DUB_FR", pais: "França", cidade: "Paris", origem: "Dublin", coords: { x: 194, y: 56 }, flag: "🇫🇷" },
    { id: "DUB_US", pais: "EUA", cidade: "Nova York", origem: "Dublin", coords: { x: 107, y: 61 }, flag: "🇺🇸" },
    { id: "DUB_PT", pais: "Portugal", cidade: "Lisboa", origem: "Dublin", coords: { x: 165, y: 72 }, flag: "🇵🇹" },
    { id: "DUB_OS", pais: "Noruega", cidade: "Oslo", origem: "Dublin", coords: { x: 204, y: 25 }, flag: "🇳🇴" },

    // De Bruxelas
    { id: "BRU_FR", pais: "França", cidade: "Paris", origem: "Bruxelas", coords: { x: 194, y: 56 }, flag: "🇫🇷" },
    { id: "BRU_NL", pais: "Holanda", cidade: "Amsterdã", origem: "Bruxelas", coords: { x: 194, y: 38 }, flag: "🇳🇱" },
    { id: "BRU_DE", pais: "Alemanha", cidade: "Berlim", origem: "Bruxelas", coords: { x: 206, y: 42 }, flag: "🇩🇪" },
    { id: "BRU_GB", pais: "Reino Unido", cidade: "Londres", origem: "Bruxelas", coords: { x: 184, y: 38 }, flag: "🇬🇧" },
    { id: "BRU_CH", pais: "Suíça", cidade: "Zurich", origem: "Bruxelas", coords: { x: 198, y: 52 }, flag: "🇨🇭" },

    // De Oslo
    { id: "OSL_DE", pais: "Alemanha", cidade: "Berlim", origem: "Oslo", coords: { x: 206, y: 42 }, flag: "🇩🇪" },
    { id: "OSL_GB", pais: "Reino Unido", cidade: "Londres", origem: "Oslo", coords: { x: 184, y: 38 }, flag: "🇬🇧" },
    { id: "OSL_FR", pais: "França", cidade: "Paris", origem: "Oslo", coords: { x: 194, y: 56 }, flag: "🇫🇷" },
    { id: "OSL_DU", pais: "Irlanda", cidade: "Dublin", origem: "Oslo", coords: { x: 172, y: 35 }, flag: "🇮🇪" },

    // De Praga
    { id: "PRA_AT", pais: "Áustria", cidade: "Viena", origem: "Praga", coords: { x: 215, y: 52 }, flag: "🇦🇹" },
    { id: "PRA_DE", pais: "Alemanha", cidade: "Berlim", origem: "Praga", coords: { x: 206, y: 42 }, flag: "🇩🇪" },
    { id: "PRA_MU", pais: "Alemanha", cidade: "Munique", origem: "Praga", coords: { x: 210, y: 56 }, flag: "🇩🇪" },
    { id: "PRA_HU", pais: "Hungria", cidade: "Budapeste", origem: "Praga", coords: { x: 218, y: 54 }, flag: "🇭🇺" },

    // De Budapeste
    { id: "BUD_AT", pais: "Áustria", cidade: "Viena", origem: "Budapeste", coords: { x: 215, y: 52 }, flag: "🇦🇹" },
    { id: "BUD_PR", pais: "República Tcheca", cidade: "Praga", origem: "Budapeste", coords: { x: 214, y: 48 }, flag: "🇨🇿" },
    { id: "BUD_IT", pais: "Itália", cidade: "Roma", origem: "Budapeste", coords: { x: 212, y: 70 }, flag: "🇮🇹" },
    { id: "BUD_TR", pais: "Turquia", cidade: "Istambul", origem: "Budapeste", coords: { x: 221, y: 61 }, flag: "🇹🇷" },

    // De Atenas
    { id: "ATE_IT", pais: "Itália", cidade: "Roma", origem: "Atenas", coords: { x: 212, y: 70 }, flag: "🇮🇹" },
    { id: "ATE_EG", pais: "Egito", cidade: "Cairo", origem: "Atenas", coords: { x: 224, y: 76 }, flag: "🇪🇬" },
    { id: "ATE_TR", pais: "Turquia", cidade: "Istambul", origem: "Atenas", coords: { x: 221, y: 61 }, flag: "🇹🇷" },
    { id: "ATE_ES", pais: "Espanha", cidade: "Madrid", origem: "Atenas", coords: { x: 180, y: 65 }, flag: "🇪🇸" },
    { id: "ATE_AE", pais: "Emirados Árabes", cidade: "Dubai", origem: "Atenas", coords: { x: 250, y: 82 }, flag: "🇦🇪" },

    // Rotas de volta e conexões extras
    { id: "GB_DU", pais: "Irlanda", cidade: "Dublin", origem: "Londres", coords: { x: 172, y: 35 }, flag: "🇮🇪" },
    { id: "PAR_BR", pais: "Bélgica", cidade: "Bruxelas", origem: "Paris", coords: { x: 194, y: 42 }, flag: "🇧🇪" },
    { id: "AMS_BR", pais: "Bélgica", cidade: "Bruxelas", origem: "Amsterdã", coords: { x: 194, y: 42 }, flag: "🇧🇪" },
    { id: "BER_OS", pais: "Noruega", cidade: "Oslo", origem: "Berlim", coords: { x: 204, y: 25 }, flag: "🇳🇴" },
