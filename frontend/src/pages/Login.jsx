...
export default function Login() {
    ...
    function loginComFacebookMock() {
        setLoading(true);
        // Mocking a Facebook login success
        setTimeout(() => {
            const googleName = "Agente Meridian";
            const googleAvatar = "";
                    ...
                    <div className="om-row" style={{ marginTop: 18 }}>
                        {!showNamePrompt ? (
                            <div className="om-oauth">
                                ...
                                <div style={{ fontSize: "11px", opacity: 0.55, textAlign: "center", marginTop: 12 }}>
                                    O mundo é um lugar perigoso. Identifique-se primeiro.
                                </div>
                            </div>
                        ) : (
                            <>
                                ...
                                <div style={{ fontSize: "11px", opacity: 0.55, textAlign: "center", marginTop: 2 }}>
                                    Você pode alterar o nome do seu Agente se desejar.
                                </div>
                            </>
                        )}
                    </div>
